...
function Nav() {
  return (
    <nav style={{ position: 'fixed', top: 0, left: 0, right: 0, zIndex: 100, padding: '0.65rem 1.5rem', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '2rem', background: 'rgba(6,6,14,0.75)', backdropFilter: 'blur(30px)', borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
      ...
      <a href="/tools-app" style={{ fontSize: '0.82rem', fontWeight: 500, color: '#6366f1', textDecoration: 'none' }}>Tools</a>
      <a href="/#how-it-works" style={{ fontSize: '0.82rem', fontWeight: 500, color: 'rgba(255,255,255,0.55)', textDecoration: 'none' }}>How it works</a>
      <a href="/static/tuesday-test.html" style={{ fontSize: '0.82rem', fontWeight: 500, color: 'rgba(255,255,255,0.55)', textDecoration: 'none' }}>ROI Calculator</a>
  ...
  return (
    <footer style={{ background: 'rgba(0,0,0,0.3)', borderTop: '1px solid rgba(255,255,255,0.06)', padding: '48px 40px 24px', marginTop: 40 }}>
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 32, maxWidth: 800, margin: '0 auto' }}>
        <div><div style={{ fontSize: 12, fontWeight: 500, color: 'rgba(255,255,255,0.5)', textTransform: 'uppercase', letterSpacing: '1px', marginBottom: 12 }}>Product</div><a href="/static/tools.html" style={{ display: 'block', fontSize: 13, color: 'rgba(255,255,255,0.35)', textDecoration: 'none', lineHeight: 2 }}>Tools</a><a href="/static/tuesday-test.html" style={{ display: 'block', fontSize: 13, color: 'rgba(255,255,255,0.35)', textDecoration: 'none', lineHeight: 2 }}>ROI Calculator</a><a href="/room" style={{ display: 'block', fontSize: 13, color: 'rgba(255,255,255,0.35)', textDecoration: 'none', lineHeight: 2 }}>Room</a></div>
        <div><div style={{ fontSize: 12, fontWeight: 500, color: 'rgba(255,255,255,0.5)', textTransform: 'uppercase', letterSpacing: '1px', marginBottom: 12 }}>Resources</div><a href="/static/manifesto.html" style={{ display: 'block', fontSize: 13, color: 'rgba(255,255,255,0.35)', textDecoration: 'none', lineHeight: 2 }}>Methodology</a><a href="/static/trust_badges.html" style={{ display: 'block', fontSize: 13, color: 'rgba(255,255,255,0.35)', textDecoration: 'none', lineHeight: 2 }}>Trust Badges</a></div>
        <div><div style={{ fontSize: 12, fontWeight: 500, color: 'rgba(255,255,255,0.5)', textTransform: 'uppercase', letterSpacing: '1px', marginBottom: 12 }}>Company</div><a href="/static/pricing.html" style={{ display: 'block', fontSize: 13, color: 'rgba(255,255,255,0.35)', textDecoration: 'none', lineHeight: 2 }}>Pricing</a><a href="mailto:drake@aidashboard.co" style={{ display: 'block', fontSize: 13, color: 'rgba(255,255,255,0.35)', textDecoration: 'none', lineHeight: 2 }}>Contact</a></div>
      </div>
      <div style={{ maxWidth: 800, margin: '32px auto 0', paddingTop: 20, borderTop: '1px solid rgba(255,255,255,0.06)', fontSize: 11, color: 'rgba(255,255,255,0.25)', textAlign: 'center' }}>© 2026 Praxis by AI Dashboard</div>
    </footer>
  );
}
