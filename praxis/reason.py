...
def deep_reason_v2(
    ...
    if _VERTICALS_OK:
        try:
            ...
            if vertical_ctx and vertical_ctx.get("verticals"):
    ...
    if safety_ctx:
        ...
        pat = safety_ctx.get("recommended_pattern", {})
        ...
        tools_recommended=[
            {
                ...
                "vertical_id": vertical_ctx["verticals"][0]["vertical_id"] if vertical_ctx and vertical_ctx.get("verticals") else None,
            }
            for t in top_tools[:8]
        ],
        narrative=narrative,
