...
| Metric | Value |
|--------|-------|
| **Python modules** | 89 files, ~47,300 lines |
...
| **Total LOC** | ~57,500 (Python + Frontend) |
...
<!-- AUTO:GIT:START -->
```
622271a auto: 2026-02-25 00:06:25
a4388f1 docs(auto): update README stats [skip ci]
...
- **645 tests passing**
- **89 Python modules**, ~47,300 lines
