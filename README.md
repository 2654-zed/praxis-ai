...
| Metric | Value |
|--------|-------|
| **Python modules** | 95 files, ~51,500 lines |
...
| **Frontend** | 26 HTML + 4 JS files (~11,300 lines), Liquid Glass UI |
| **Versions** | 17 major iterations (v1 → v17) |
| **Total LOC** | ~62,800 (Python + Frontend) |
| **Zero external ML deps** | All NLP, scoring, graph, and retrieval are zero-dependency |
| **Last auto-update** | 2026-02-25 20:22 UTC |
<!-- AUTO:STATS:END -->
...
2719ec6 auto: 2026-02-25 12:36:45
4450594 docs(auto): update README stats [skip ci]
f792fe3 auto: 2026-02-25 12:36:13
011d8db docs(auto): update README stats [skip ci]
ee60538 auto: 2026-02-25 12:35:10
4435182 docs(auto): update README stats [skip ci]
36833a3 auto: 2026-02-25 12:34:38
36e9499 docs(auto): update README stats [skip ci]
01f2485 auto: 2026-02-25 12:33:06
ba7534c docs(auto): update README stats [skip ci]
6a11fec auto: 2026-02-25 12:32:33
888b81f docs(auto): update README stats [skip ci]
22781fb auto: 2026-02-25 12:26:01
fdefd7c docs(auto): update README stats [skip ci]
a3eb47d auto: 2026-02-25 12:23:58
cc35c18 docs(auto): update README stats [skip ci]
```
<!-- AUTO:GIT:END -->
...
- **645 tests passing**
- **95 Python modules**, ~51,500 lines
- **30 frontend files**, ~11,300 lines
